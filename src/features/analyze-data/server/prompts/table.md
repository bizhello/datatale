...
Write every user-visible label, chart title, rationale, and no-chart reason in Russian. Preserve source field names when they are identifiers from the supplied data.
