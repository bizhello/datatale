      ...
      {onAnalyze ? (
        <div className="analysis-action">
          <p className="analysis-note">
            ...
            хранения действуют отдельно. Сам полный источник не хранится; на 15
            минут сохраняется результат с показанными фрагментами доказательств,
            а счётчики безопасности — не дольше 48 часов. После обновления
            страницы показанный отчёт исчезнет.
          </p>
